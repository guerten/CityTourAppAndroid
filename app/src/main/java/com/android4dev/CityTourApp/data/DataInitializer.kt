...
class DataInitializer {
    ...
    private fun addTouristicPlacesToList() {
        ...
        touristicPlacesList.add(TouristicPlace("El pilar", "subtitulo de el pilar la pilarica maña que baila y baila sin paraaaar","el_pilar",  Coordinates(41.6562918,-0.8804382),"no description el siguiente", 9.3, "https://www.audioguias-bluehertz.es/audioguia_zaragoza/ingles/en_01_plazapilar.mp3", TP_Type.BUSINESS))
